...
public class Input 
{
	...
	public static final int KEY_PAGE_UP         = 0xC9;
	...
	public static final int KEY_PAGE_DOWN     	= 0xD1;
	...
	{
		return new Vector2f(Mouse.getX(), Screen.HEIGHT - Mouse.getY());
	}
	...
	public static void grabCursor(boolean enabled)
	{
